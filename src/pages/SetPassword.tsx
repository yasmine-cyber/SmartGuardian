          ...
          <AnimatePresence mode="wait">
            {!sessionReady ? (
              ...
              >
                ...
                <p className="text-muted-foreground text-sm">Vérification de l'invitation...</p>
              </motion.div>
            ) : !done ? (
              <motion.div
                key="form"
              ...
              >
                ...
                <p className="text-muted-foreground text-sm mb-8">
                  Bienvenue ! Définissez un mot de passe sécurisé pour accéder à votre espace médecin.
                </p>
              ...
              >
                ...
                <Link to="/doctor" className="text-sm text-primary hover:underline font-medium">
                  Accéder maintenant
                </Link>
              </motion.div>
            )}
